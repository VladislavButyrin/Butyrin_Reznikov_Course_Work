...
namespace TravelAgencyView
{
    ...
    public partial class PlaceFrame : Window
    {
        ...
        private readonly OrganizatorBusinessLogic organizator_logic;
        private int? id;
        private Dictionary<int, string> placeTrips;
        public PlaceFrame(PlaceBusinessLogic servic_logic, TripBusinessLogic trip_logic, OrganizatorBusinessLogic organizator_logic)
        {
            InitializeComponent();
