...
namespace TravelAgencyBusinessLogic.BusinessLogic.Guarantor
{
    class SaveToPdfGuarantor
    {
        ...
        public static void CreateDoc(PdfInfo info)
        {
            ...
            {
                Table = table,
                Texts = new List<string> { "Дата", "Место", "Гид"},
                Style = "NormalTitle",
                ParagraphAlignment = ParagraphAlignment.Center
            });
            foreach (var placeguide in info.PlacesGuides)
            {
                CreateRow(new PdfRowParameters
                {
                    Table = table,
                    Texts = new List<string> { placeguide.Date.ToShortDateString(),
placeguide.PlaceName, placeguide.GuideName},
                    Style = "Normal",
